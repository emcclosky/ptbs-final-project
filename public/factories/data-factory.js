(function(){
    angular.module('app')
      .factory('DataFactory', function(){
        ...
        var cities = [
                {name: 'Bangkok', airport: 'BKK', tag: ['beach', 'crowded', 'adventure', 'party'], id: 1, activities:['Explore the Temple of the Emerald Buddha', 'Shop at the Floating Market', 'Tour the Summer Palace'], img: 'http://static.asiawebdirect.com/m/bangkok/portals/bangkok-com/shared/teasersL/TOURS/discover-bangkok-in-2-days/teaserMultiLarge/imageHilight/bangkok-day-trip.jpg'},
